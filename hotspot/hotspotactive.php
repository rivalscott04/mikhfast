...
// routeros api
	...
	if ($serveractive != "") {
		$gethotspotactive = $router->getHotspotActive($serveractive);
		$TotalReg = count($gethotspotactive);

		$counthotspotactive = $router->countHotspotActiveFiltered($serveractive);

	} else {
		$gethotspotactive = $router->getHotspotActive(null);
		$TotalReg = count($gethotspotactive);

		$counthotspotactive = $router->countHotspotActiveFiltered(null);
	}
}
?>
<div class="row">
