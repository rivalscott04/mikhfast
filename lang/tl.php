...
$_router_limit_reached = "Naabot na ang limit ng router";
$_empty_routers = "Walang nakakonektang router";
$_empty_routers_hint = "Magdagdag ng unang MikroTik router para magsimula.";
$_add_router_first = "Magdagdag ng Unang Router";
$_manage_routers = "Pamahalaan ang Router";
$_router_name = "Pangalan ng Router";
$_test_connection = "Test Connection";
$_connection_ok = "Connected";
$_connection_failed = "Connection failed";
$_router_offline = "Offline ang router";
$_last_online = "Huling online";
$_retry = "Subukan muli";
$_storage_warning = "Storage {pct}% puno";
$_storage_critical = "Storage kritikal ({pct}% natitira)";
$_storage_banner = "Halos puno na ang storage ng router. Burahin ang lumang report.";
$_storage_tiny_hint = "Napakaliit ng storage ng router na ito. Regular na mag-purge ng lumang report.";
$_storage_warn_hint = "Halos puno na ang storage. Burahin ang lumang report o mag-connect ng USB.";
$_storage_critical_hint = "Kritikal ang storage — maaaring hindi stable ang router.";
$_purge_old_reports = "Burahin ang report > {days} araw";
$_purge_reports_confirm = "Burahin ang {count} lumang report mula sa router na ito?";
$_log_unavailable_storage = "Hindi available ang log — puno ang storage ng router";
$_mikrotik_api_guide = "Gabay sa MikroTik API setup";
$_save = "Sagipin";
$_search = "Hanapin";
$_sec = "sec";
$_seconds = "segundo";
...
<li>Para sa buwanang pag sala/Filter. Piliin and Araw at Buwan, pagkatapos ay pindutin ang Sala/Filter.<br>
	...
	<li>I-filter batay sa mga komento, punan ang !!Magkomento sa hanay ng Paghahanap, pagkatapos ay i-click ang filter. O i-click ang isa sa mga komento. (MIKFAST Online).</li>
