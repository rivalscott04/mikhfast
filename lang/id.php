...
$_toast_logo_not_writable = "Folder img/ belum writable. Jalankan: chmod 775 img/ lalu chown ke user web server (www-data/nginx).";
$_toast_logo_upload_failed = "Gagal upload logo. Folder img/ harus writable (chmod 775).";
