...
$_toast_logo_upload_failed = "Gagal upload logo. Periksa permission folder img/ (chmod 775).";
$_toast_logo_not_writable = "Folder img/ tidak bisa ditulis. Set permission 775 untuk user web server.";
