...
$_toast_logo_upload_failed = "Logo upload failed. Check img/ folder permission (chmod 775).";
$_toast_logo_not_writable = "img/ folder is not writable. Set permission to 775 for the web server user.";
