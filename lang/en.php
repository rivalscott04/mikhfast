...
$_toast_logo_not_writable = "img/ folder is not writable. Run: chmod 775 img/ then chown to your web server user (www-data/nginx).";
$_toast_logo_upload_failed = "Logo upload failed. img/ folder must be writable (chmod 775).";
