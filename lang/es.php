...
$_routers = "Routers";
$_router_hub = "Todos los Routers";
$_account_settings = "Configuración de Cuenta";
$_open_router = "Abrir";
$_online = "En línea";
$_offline = "Desconectado";
$_unknown = "Desconocido";
$_router_limit = "%d/%d routers";
$_router_limit_reached = "Límite de routers alcanzado";
$_empty_routers = "Aún no hay routers conectados";
$_empty_routers_hint = "Agregue su primer router MikroTik para comenzar.";
$_add_router_first = "Agregar Primer Router";
$_manage_routers = "Administrar Routers";
$_router_name = "Nombre del Router";
$_test_connection = "Probar Conexión";
$_connection_ok = "Conectado";
$_connection_failed = "Conexión fallida";
$_router_offline = "Router desconectado";
$_last_online = "Última conexión";
$_retry = "Reintentar";
$_storage_warning = "Almacenamiento {pct}% lleno";
$_storage_critical = "Almacenamiento crítico ({pct}% libre)";
$_storage_banner = "El almacenamiento del router está casi lleno. Elimine informes antiguos.";
$_storage_tiny_hint = "Este router tiene almacenamiento muy limitado. Elimine informes antiguos regularmente.";
$_storage_warn_hint = "Almacenamiento casi lleno. Elimine informes antiguos o conecte almacenamiento USB.";
$_storage_critical_hint = "Almacenamiento crítico — el router puede volverse inestable.";
$_purge_old_reports = "Eliminar informes de más de {days} días";
$_purge_reports_confirm = "¿Eliminar {count} entradas de informes antiguos de este router?";
$_log_unavailable_storage = "Log no disponible — almacenamiento del router lleno";
$_mikrotik_api_guide = "Guía de configuración API MikroTik";
$_save = "Guardar";
$_search = "Buscar";
$_sec = "sec";
$_seconds = "segundos";
...
<li>Para los filtros por mes, seleccione Día y mes, luego haga clic en Filtro.<br>
	...
	<li>Filtre en base a los comentarios, complete el !!Comentario en la columna Buscar y luego haga clic en filtro O haga clic en uno de los comentarios. (MIKFAST Online).</li>
